...
| [reviews/2026-09-22-release-tag-semantics/](reviews/2026-09-22-release-tag-semantics/) | 讨论留档 | in-progress | §5.7 发版与标签语义修订 §9 会议（源 issue #4）。三轮全部归档，计票与多数条文合并稿见 round-3/tally.md，已呈维护者最终裁定；裁定生效前固定层、快照与模板保持原样 |
